            ...
            >
              ...
              <div className="pt-6 border-t border-gray-200 mt-auto flex flex-col gap-4">
                <button
                  ...
                  className="w-full bg-[#2E7D32] hover:bg-[#1F5E2E] text-white font-sans font-bold py-3 px-5 rounded-full flex items-center justify-center gap-2 shadow cursor-pointer"
